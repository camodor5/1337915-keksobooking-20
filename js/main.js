...
var getPinTemplate = function () {
  pinTemplate = document.querySelector('#pin');
  if (pinTemplate && pinTemplate.content) {
    return pinTemplate.content.querySelector('.map__pin');
  }
};
...
var drawPins = function (items) {
  ...
  items.forEach(function (item) {
    var pinElement = createPinElement(item);
